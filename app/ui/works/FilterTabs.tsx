  ...
  return (
    <>
      <button
        ...
        onClick={onClick}
        className={clsx(
          "hidden md:flex flex-row items-center justify-center md:p-2 border-b-[1px] border-b-slate-200 min-w-16 md:w-28 text-slate-400 p-0 z-[2] relative",
          {
            "!border-b-2 !border-b-black !text-black font-semibold":
              active === type && theme === "light",
          },
          {
